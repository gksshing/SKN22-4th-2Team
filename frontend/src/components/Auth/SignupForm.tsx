 ...
 *
 * - 이메일 / 비밀번호 / 비밀번호 확인 / 닉네임 필드
 * - onBlur 시 인라인 에러 표시 (alert 금지)
 * - 제출 시 전체 필드 일괄 검증 후 회원가입 API 호출
 */
            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-2xl shadow-2xl p-8">
                    ...
                    <form onSubmit={handleSubmit} noValidate className="space-y-4">
                        ...
                        {/* 닉네임 */}
                        <div>
                            <label htmlFor="signup-nickname" className="block text-sm font-semibold text-gray-700 mb-1">
                                닉네임
                            </label>
                            <input
                                id="signup-nickname"
                        ...
                        {/* 비밀번호 확인 */}
                        <div>
                            <label htmlFor="signup-confirm-password" className="block text-sm font-semibold text-gray-700 mb-1">
                                비밀번호 확인
                            </label>
                            <input
